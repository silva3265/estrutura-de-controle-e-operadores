...
public class ExercicioAnoBissexto {
	 ...
	 * etc São bissextos todos os múltiplos de 4 e não múltiplos de 100, por
	 * exemplo: 1996, 2004, 2008, 2012, etc Não são bissextos todos os demais anos
	 * Desenvolva um programa que, dado um ano digitado pelo usuário, imprime na
	 * tela se é um ano bissexto ou não.
	 * 
	 * Dica de matemática: para saber se um número é múltiplo de outro, basta
	 * realizar o cálculo de módulo (resto da divisão). Um número é múltiplo de
	 * outro se o módulo for igual a 0.
	 */
