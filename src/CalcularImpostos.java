...
public class CalcularImpostos {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * if (tipoNotaFiscal == 'S') { valorImpostos = totalFaturado * 0.16; } else {
		 * valorImpostos = totalFaturado * 0.35; }
		 */

		// double valorImpostos = tipoNotaFiscal == 'S' ? totalFaturado * 0.16 :
		// totalFaturado * 0.35;

		double taxaImpostos = tipoNotaFiscal == 'S' ? 0.16 : 0.35; // Operador Ternario
