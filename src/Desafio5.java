...
public class Desafio5 {
	...
	/*
	 * 5) Desafio da estrutura do-while Escreva um programa que solicita números
	 * inteiros para o usuário de forma "infinita", até que o usuário escolha não
	 * digitar mais nenhum número (pergunte ao usuário após informar cada número).
	 * 
	 * Some todos os números ímpares e todos os números pares e imprima na saída o
	 * resultado.
	 */
